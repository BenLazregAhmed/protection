...
var Carousel = React3.forwardRef(({
  ...
  const nextDirectionRef = (0, import_react2.useRef)(null);
  const [direction, setDirection] = (0, import_react2.useState)("next");
  const [paused, setPaused] = (0, import_react2.useState)(false);
  const [isSliding, setIsSliding] = (0, import_react2.useState)(false);
  const [renderedActiveIndex, setRenderedActiveIndex] = (0, import_react2.useState)(activeIndex || 0);
  ...
  const prev = (0, import_react2.useCallback)((event) => {
    if (isSliding) {
      return;
    }
  ...
  const handleEnter = (0, import_react2.useCallback)((node) => {
    triggerBrowserReflow(node);
    onSlide == null ? void 0 : onSlide(renderedActiveIndex, slideDirection);
  }, [onSlide, renderedActiveIndex, slideDirection]);
  const handleEntered = (0, import_react2.useCallback)(() => {
    setIsSliding(false);
    onSlid == null ? void 0 : onSlid(renderedActiveIndex, slideDirection);
  ...
  const handleMouseOut = (0, import_react2.useCallback)((event) => {
    setPaused(false);
    onMouseOut == null ? void 0 : onMouseOut(event);
  }, [onMouseOut]);
  const touchStartXRef = (0, import_react2.useRef)(0);
  const touchDeltaXRef = (0, import_react2.useRef)(0);
  ...
  const handleTouchEnd = (0, import_react2.useCallback)((event) => {
    if (touch) {
  ...
  const intervalHandleRef = (0, import_react2.useRef)();
  (0, import_react2.useEffect)(() => {
  ...
  const indicatorOnClicks = (0, import_react2.useMemo)(() => indicators && Array.from({
    length: numChildren
  }, (_, index) => (event) => {
...
//# sourceMappingURL=chunk-QKDJJAYM.js.map
