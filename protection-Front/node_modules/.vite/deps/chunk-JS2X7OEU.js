...
var CardImgOverlay = React3.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  ...props
...
var CardLink = React4.forwardRef(({
  className,
  bsPrefix,
  as: Component = "a",
  ...props
...
var CardSubtitle = React5.forwardRef(({
  className,
  bsPrefix,
...
var Card = React7.forwardRef(({
  ...
  return (0, import_jsx_runtime7.jsx)(Component, {
    ref,
    ...props,
    className: (0, import_classnames7.default)(className, prefix, bg && `bg-${bg}`, text && `text-${text}`, border && `border-${border}`),
    children: body ? (0, import_jsx_runtime7.jsx)(CardBody_default, {
      children
    }) : children
  });
});
...
//# sourceMappingURL=chunk-JS2X7OEU.js.map
