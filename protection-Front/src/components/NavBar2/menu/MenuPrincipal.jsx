  ...
  return (
    <div className='menu-principal-div'>
            ...
            <Row className='menu-items-row'>
                ...
                <Col lg='2' md='1' xs='0' >
                    <p onMouseEnter={()=>{setMouseOnPartenaire(true)}} onMouseLeave={()=>{setMouseOnPartenaire(false)}}>Partenaires</p>
                </Col>
                <Col lg='2' md='1' xs='0' >
                    <p onMouseEnter={()=>{setMouseOnBeneficiare(true)}} onMouseLeave={()=>{setMouseOnBeneficiare(false)}}>Bénéficaires</p>
                </Col>
                <Col lg='1' md='1' xs='0' >
                    <p onMouseEnter={()=>{setMouseOnProjet(true)}} onMouseLeave={()=>{setMouseOnProjet(false)}}>Projets</p>
                </Col>
                <Col lg='2' md='1' xs='0'>
