  ...
  return (
    <div className='drop-down' onMouseEnter={mouseOn} onMouseLeave={mouseOff}>
        <Container>
            <Row>
                <Col lg='3'>
                    <DropDownSection1 title={''} text={'Explorez notre plateforme dédiée à la sauvegarde des espèces rares. Nous œuvrons passionnément pour la protection des animaux et des plantes en voie de disparition. Rejoignez-nous dans cette mission vitale pour préserver la diversité biologique de notre planète.'} url={'/Association'}></DropDownSection1>
                </Col>
                <Col lg='4'>
