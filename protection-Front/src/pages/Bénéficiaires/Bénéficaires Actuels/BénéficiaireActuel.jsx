    ...
    const beneficiairesData = [
      ...
      return (
        ...
        <Container className="mt-5">
          <h1 className='t'>Bénéficiaires Actuels de l'Association</h1>
          <Row>
            <h2 className='itemBénef'>Projets et Programmes :</h2>
          ...
          <Row>
            <h2 className='itemBénef'>Associations : </h2>
            {beneficiairesData.map((beneficiaire, index) => (
              <Col key={index} md={6} lg={4} className="mb-4">
                <Card className='card-beneficiaire'>
                  <Card.Body>
                    <Card.Title className='card-beneficiaire-title'>{beneficiaire.nom}</Card.Title>
                    <Card.Text className='card-beneficiaire-desc'>{beneficiaire.mission}</Card.Text>
